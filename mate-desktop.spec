...
Source1:        mate-fedora-f22.gschema.override
...
%if 0%{?fedora} >= 23
install -D -m 0644 %SOURCE2 %{buildroot}%{_datadir}/glib-2.0/schemas/mate-fedora.gschema.override
%endif

%if 0%{?fedora} >= 24
install -D -m 0644 %SOURCE3 %{buildroot}%{_datadir}/glib-2.0/schemas/mate-fedora.gschema.override
%endif
...
%if 0%{?rhel}
install -D -m 0644 %SOURCE5 %{buildroot}%{_datadir}/glib-2.0/schemas/mate-rhel.gschema.override
%endif
...
%if 0%{?fedora}
%ghost %{_datadir}/X11/xorg.conf.d/99-synaptics-mate.conf
%endif
%{_mandir}/man1/*
